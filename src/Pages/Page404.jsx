...
function Page404() {
    return (
        <div class="container mx-auto px-4">
            <section class="py-8 px-4 mt-48 md:mt-64 lg:mt-40 text-center">
                <div class="max-w-auto mx-auto">
                    <div class="md:max-w-lg mx-auto">
                        <svg class="fill-current text-grey" viewBox="0 0 445 202" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h2 class="mt-8 uppercase text-xl lg:text-5xl font-black text-grey">We are sorry, Page not found!</h2>
                    <p class="mt-6 uppercase text-sm lg:text-base text-grey">The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
                    <a href="/" class="mt-6 bg-blue-light hover:bg-blue border border-transparent border-green text-green font-serif font-light py-4 px-6 rounded-full inline-block uppercase shadow-lg">Back To Homepage</a>
                </div>
            </section>
        </div>
    )
