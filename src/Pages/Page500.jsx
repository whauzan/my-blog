        ...
        <div class="container mx-auto px-4">
            <section class="py-8 px-4 mt-48 md:mt-64 lg:mt-40 text-center">
                <div class="max-w-auto mx-auto">
                    ...
                    <h2 class="mt-8 uppercase text-xl lg:text-5xl font-black text-grey">We're sorry, but something went wrong.</h2>
                    <p class="mt-6 uppercase text-sm lg:text-base text-grey">If you are the application's owner check the logs for more information.</p>
